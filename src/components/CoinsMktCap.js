...
const Coins = () => {
  ...
  return (
    <>
      <div className=" dark:bg-stone-800 w-full mt-4 dark:border-0 border-2 dark:shadow-black border-yellow-400 h-full shadow-lg hover:duration-300 hover:shadow-2xl rounded-lg bg-white">
        <div className=" p-5 rounded-xl dark:bg-stone-800  bg-white">
          <h2 className="text-xl dark:text-yellow-400 dark:bg-stone-800 font-black font-comfortaa">
                ...
                {data.map((coin) => (
                  ...
                  >
                    ...
                    <div className="coin-name ">
                      ...
                      <p className="text-sm dark:text-yellow-400 text-slate-600">
                    ...
                    {coin.price_change_24h < 0 ? (
                      ...
                      <div className="coin-rate flex dark:bg-stone-800 bg-white items-center">
                        ...
                        <h4 className="text-green-600 font-semibold">{coin.price_change_24h.toFixed(4)}%</h4>
                      </div>
                    )}
                  </div>
                ))}
